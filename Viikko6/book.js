const book = {
    ...
    getOneBook: function(id) {
        const foundBook = this.bookArray.find(book => book.id_book === id);
        if(foundBook) {
...
console.log("Haetaan kaikki kirjat");
book.getAllBooks();

console.log("Haetaan kirja id:llä 4");
book.getOneBook(4);

console.log("Lisätään uusi kirja");
book.addBook(16, "New Book", "New Author", "1234567890");

console.log("Haetaan päivitetty lista kaikista kirjoista");
book.getAllBooks();